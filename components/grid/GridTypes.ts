...
export type GridEngineOptions<RowId extends string, ColKey extends string> = {
  ...
  getCellState?: (rowId: RowId, colKey: ColKey) => unknown;
  getClearedCellState?: (rowId: RowId, colKey: ColKey) => unknown;
  restoreCellStates?: (changes: Array<{ rowId: RowId; colKey: ColKey; state: unknown }>) => void;
